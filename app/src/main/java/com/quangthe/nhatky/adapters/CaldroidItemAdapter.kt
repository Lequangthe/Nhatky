...
import com.quangthe.nhatky.databinding.FragmentCustomCellBinding
...
//                    }
                    ...
                    val count = diaryRepository.countDiaryBy(dateString)
                    ...
                    val ascending = context.config.calendarSorting == CALENDAR_SORTING_ASC
                    val mDiaryList = diaryRepository.findDiaryByDateString(dateString, ascending)
                    itemCount.run {
