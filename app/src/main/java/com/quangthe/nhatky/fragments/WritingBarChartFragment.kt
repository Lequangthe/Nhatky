...
import com.quangthe.nhatky.compose.StatisticsActivity
import com.quangthe.nhatky.chart.DiaryCountingAxisValueFormatter
import com.quangthe.nhatky.chart.IValueFormatterExt
import com.quangthe.nhatky.chart.XYMarkerView
import com.quangthe.nhatky.extensions.config
import com.quangthe.nhatky.extensions.updateDrawableColorInnerCardView
import com.quangthe.nhatky.helper.ChartConstants
...
//        barChart.zoom(1.5F, 0F, 0F, 0F)
    ...
    private suspend fun setData(count: Int = 8): ArrayList<BarEntry> {
        ...
        val listDiary = diaryRepository.findDiary(null)
