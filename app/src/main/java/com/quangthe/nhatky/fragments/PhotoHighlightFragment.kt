...
import com.quangthe.nhatky.adapters.HistoryAdapter
import com.quangthe.nhatky.databinding.FragmentPhotoHighlightBinding
...
import com.quangthe.nhatky.views.FigureIndicatorView
            ...
            when (mBannerHistory.adapter.itemCount == 0) {
                true -> {
                    lifecycleScope.launch {
                        diaryRepository.findOldestDiary()?.let { oldestDiary ->
                            ...
                            suspend fun makeHistory(
                                ...
                                var diaryItems = diaryRepository.findDiary(null, false, pastMillis, pastMillisBuffer)
                                if (diaryItems.isEmpty()) {
                                    for (i in 1..noDataDayBufferMaxLoop) {
                                        diaryItems = diaryRepository.findDiary(null, false, pastMillis, pastMillisBuffer.plus(i * oneDayMillis))
