...
class SettingsActivity : BaseSettingsActivity() {
    ...
    override fun manualUrl(): String = when (mCurrentPosition) {
        0 -> getString(R.string.user_manual_url_basic)
        1 -> getString(R.string.user_manual_url_font)
        2 -> getString(R.string.user_manual_url_lock)
        3 -> getString(R.string.user_manual_url_backup_restore_device)
        4 -> getString(R.string.user_manual_url_schedule)
        else -> getString(R.string.user_manual_url_application_information)
    }
}